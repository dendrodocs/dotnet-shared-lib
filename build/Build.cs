...
class Build : NukeBuild
{
    ...
    // Use GitVersion for versioning—automatically derives semantic version from git history
    [Required]
    [GitVersion(Framework = "net8.0", NoCache = true, NoFetch = true)]
    readonly GitVersion GitVersion;

    // Run sbom-tool from NuGet as a local tool—ensures reproducibility
    [NuGetPackage(
    ...
    // All output and intermediate directories, clearly named and isolated
    ...
    Target UnitTests => _ => _
        ...
        {
            DotNetTest(_ => _
                .SetProjectFile(Solution.tests.DendroDocs_Shared_Tests.Directory)
